"""Summarize Focused Research Grid v2A results.
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Summarize focused Research Grid v2A registry.")
...
def main() -> None:
    ...
    print("Focused research v2A global summary generated")
